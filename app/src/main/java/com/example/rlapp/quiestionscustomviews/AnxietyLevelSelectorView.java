...
public class AnxietyLevelSelectorView extends View {
    ...
    public AnxietyLevelSelectorView(Context context) {
        super(context);
        init();
    }

    public AnxietyLevelSelectorView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public AnxietyLevelSelectorView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        RectF fillRect = new RectF(capillaryRect.left+30, capillaryRect.bottom - fillHeight, capillaryRect.right-30, capillaryRect.bottom);
