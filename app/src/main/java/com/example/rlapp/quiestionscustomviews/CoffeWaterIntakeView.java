...
public class CoffeWaterIntakeView extends View {
    ...
    public CoffeWaterIntakeView(Context context) {
        super(context);
        init();
    }

    public CoffeWaterIntakeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CoffeWaterIntakeView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // Draw rounded slider
        canvas.drawRoundRect(capillaryRect, capillaryRect.width() / 4, capillaryRect.width() / 4, backgroundPaint);
        ...
        canvas.drawRoundRect(fillRect, capillaryRect.width() / 4, capillaryRect.width() / 4, fillPaint);
