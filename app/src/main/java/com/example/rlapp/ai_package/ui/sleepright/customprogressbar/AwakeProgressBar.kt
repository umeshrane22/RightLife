package com.example.rlapp.ai_package.ui.sleepright.customprogressbar
...
class AwakeProgressBar @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : View(context, attrs, defStyleAttr) {
