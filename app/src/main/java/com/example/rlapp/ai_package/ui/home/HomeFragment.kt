...
import com.example.rlapp.databinding.HomeFragmentAiBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class
HomeFragment : BaseFragment<HomeFragmentAiBinding>() {
    ...
    override val bindingInflater: (LayoutInflater, ViewGroup?, Boolean) -> HomeFragmentAiBinding
        get() = HomeFragmentAiBinding::inflate
