...
import com.example.rlapp.ui.voicescan.VoiceScanPagerAdapter;
import com.zhpan.indicator.IndicatorView;

import me.relex.circleindicator.CircleIndicator3;

public class HealthAuditActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_healthaudit);
       ...
       indicator_view.setSliderWidth(80);
        ...
        int[] layouts = {
                R.layout.page_one_health, // Define these layout files in your res/layout directory
                R.layout.page_two_health,
                R.layout.page_three_health,
    ...
    private void updateButtonText(int position) {
        ...
        if (position == totalItems - 1) {
            btn_howitworks.setText("Take Assessment");
        } else {
    ...
    private void showBirthDayDialog() {
        ...
        dialogButton.setOnClickListener(v -> {
            // Perform your action
            dialog.dismiss();
            Toast.makeText(HealthAuditActivity.this, "Scan feature is Coming Soon", Toast.LENGTH_SHORT).show();
    ...
    private void showDisclaimerDialog() {
        ...
        dialogButtonStay.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(HealthAuditActivity.this, HealthAuditFormActivity.class);
