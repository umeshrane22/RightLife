            ...
            try {
                ...
                if (result.billingResult.responseCode == BillingClient.BillingResponseCode.OK) {
                    if (result.productDetailsList?.isNotEmpty() == true) {
                        ...
                        Toast.makeText(this@BillingActivity, "Product not found: $productId", Toast.LENGTH_LONG).show()
                    }
                } else {
                    Toast.makeText(this@BillingActivity, "Query failed: ${result.billingResult.debugMessage}", Toast.LENGTH_SHORT).show()
                }
            } catch (e: Exception) {
                Log.e("Billing", "Error querying product details", e)
                Toast.makeText(this@BillingActivity, "Error querying product: ${e.message}", Toast.LENGTH_SHORT).show()
            }
        }
    }
                ...
                "BOOSTER" -> {
                    lifecycleScope.launch {
                        try {
                            ...
                            if (result.billingResult.responseCode == BillingClient.BillingResponseCode.OK) {
                                Toast.makeText(this@BillingActivity, "Consumable purchase successful", Toast.LENGTH_SHORT).show()
                                //call your method to update UI or backend
                            } else {
                                Toast.makeText(this@BillingActivity, "Consume failed: ${result.billingResult.debugMessage}", Toast.LENGTH_SHORT).show()
                            }
                        } catch (e: Exception) {
                            Log.e("Billing", "Error consuming purchase", e)
                            Toast.makeText(this@BillingActivity, "Error consuming purchase: ${e.message}", Toast.LENGTH_SHORT).show()
                        }
                    }
                }
                        ...
                        lifecycleScope.launch {
                            try {
                                ...
                                if (result.responseCode == BillingClient.BillingResponseCode.OK) {
                                    Toast.makeText(this@BillingActivity, "Subscription acknowledged", Toast.LENGTH_SHORT).show()
                                    //call your method to update UI or backend
                                    showSubscriptionStatus(purchase)
                                } else {
                                    Toast.makeText(this@BillingActivity, "Acknowledge failed: ${result.debugMessage}", Toast.LENGTH_SHORT).show()
                                }
                            } catch (e: Exception) {
                                Log.e("Billing", "Error acknowledging purchase", e)
                                Toast.makeText(this@BillingActivity, "Error acknowledging purchase: ${e.message}", Toast.LENGTH_SHORT).show()
                            }
                        }
                    } else {
                        showSubscriptionStatus(purchase)
    ...
    private fun restoreSubscription() {
        lifecycleScope.launch {
            try {
                ...
                Log.e("Billing", "Error restoring subscription", e)
            }
        }
    }
