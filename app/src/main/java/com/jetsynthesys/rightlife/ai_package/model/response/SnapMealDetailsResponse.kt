...
data class SnapMealDetailsResponse(
    val status_code: Int,
    val message: String,
    val data: MealData
)
...
data class MealData(
    val meal_details: SnapMealDetails
)

data class SnapMealDetails(
    val _id: String,
    val user_id: String,
    val meal_name: String,
    val dish: List<DishList>,
    val createdAt: String,
    val updatedAt: String,
    val meal_nutrition_summary: MealNutritionSummary
)
