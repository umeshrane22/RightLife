...
data class PlanExercise( @SerializedName("activityId") val activityId: String, @SerializedName("activity_name") val activityName: String, @SerializedName("intensity") val intensity: String, @SerializedName("duration_min") val durationMin: Double, @SerializedName("calories_burned") val caloriesBurned: Double )