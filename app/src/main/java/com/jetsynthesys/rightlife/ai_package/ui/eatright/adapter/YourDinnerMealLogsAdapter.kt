...
class YourDinnerMealLogsAdapter(private val context: Context, private var dataLists: ArrayList<MealList>,
                                private var clickPos: Int, private var mealLogListData : MealList?,
                                private var isClickView : Boolean, val onMealLogDateItem: (DinnerMealModel, Int, Boolean) -> Unit,) :
    RecyclerView.Adapter<YourDinnerMealLogsAdapter.ViewHolder>() {
