...
import com.jetsynthesys.rightlife.databinding.ActivityWelcomeMoveRightContextScreenBinding

class WelcomeMoveRightContextScreenActivity : BaseActivity() {
    private lateinit var binding: ActivityWelcomeMoveRightContextScreenBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityWelcomeMoveRightContextScreenBinding.inflate(layoutInflater)
