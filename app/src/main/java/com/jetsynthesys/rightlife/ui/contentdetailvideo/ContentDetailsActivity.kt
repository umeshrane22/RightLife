...
class ContentDetailsActivity : BaseActivity() {
    ...
    private fun setcontentDetails(contentResponseObj: ModuleContentDetail?) {
        ...
        if (contentResponseObj != null) {
            ...
            if (contentResponseObj.getData().getContentType().equals("AUDIO", ignoreCase = true)) {
                // For Audio Player
                setupMusicPlayer(contentResponseObj.getData().getPreviewUrl())
    ...
    private fun setupMusicPlayer(previewUrl: String) {
        val backgroundImage = findViewById<ImageView>(R.id.backgroundImage)
        binding.rlPlayerMusicMain.setVisibility(View.VISIBLE)
        val imageUrl =
            "media/cms/content/series/64cb6d97aa443ed535ecc6ad/e9c5598c82c85de5903195f549a26210.jpg"
        ...
        val url = ApiClient.CDN_URL_QA + previewUrl //episodes.get(1).getPreviewUrl();//"https://www.example.com/your-audio-file.mp3";  // Replace with your URL
